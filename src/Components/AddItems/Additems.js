...
const Additems = () => {
    ...
    return (
        <div>
            <div>
                <div className="card lg:card-side w-3/5 mb-20 mx-auto bg-base-100 shadow-xl">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='grid grid-cols-2'>
                                ...
                                <div className="form-control w-full max-w-xs">
                                    ...
                                    <input  {...register("supplierName", { required: true })} type="text" placeholder="Type here" className="input input-bordered bg-slate-100   input-info  w-full max-w-xs" />
                                </div>
                            ...
                            <button type="submit" className="btn btn-info mt-4 w-1/5">Submit</button>
